...
{{- if ne (len .) 4 -}}
    {{- fail (printf "ERROR: template \"cert-manager-csi-driver-spiffe.image\" expects (tuple <imageValues> <imageRegistry> <imageNamespace> <defaultReference>), got %d arguments" (len .)) -}}
{{- end -}}
